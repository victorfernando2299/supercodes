...
class Bidder:
    def __init__(self):
        ...
        print('Bidder ID: ' + str(self.my_id) + ' >>> NOTA: ' + str(round(random.random()*10) % 5 + 1))
        self.loggerProducer.send('Bidder ID: ' + str(self.my_id) + ' >>> NOTA: ' + str(round(random.random()*10) % 5 + 1))
