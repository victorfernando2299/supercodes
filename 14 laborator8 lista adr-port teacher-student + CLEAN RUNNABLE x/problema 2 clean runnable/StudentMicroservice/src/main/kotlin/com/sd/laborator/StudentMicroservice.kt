...
class StudentMicroservice {
    ...
    init {
        val databaseLines: List<String> = File("/home/stefan/Documents/Rezolvari Subiecte/14TODO laborator8/problema 2/StudentMicroservice/questions_database.txt").readLines()
