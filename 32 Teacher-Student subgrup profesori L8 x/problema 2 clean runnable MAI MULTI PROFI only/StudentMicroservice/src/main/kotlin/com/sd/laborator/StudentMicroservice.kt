...
class StudentMicroservice {
    ...
    init {
        val databaseLines: List<String> = File("/home/stefan/Documents/Rezolvari Subiecte/32 Teacher-Student subgrup profesori L8/problema 2 clean runnable/StudentMicroservice/questions_database.txt").readLines()
