...
class StudentMicroservice {
    ...
    init {
        val databaseLines: List<String> = File("F:\\Materiale Facultate\\An 3\\Semestrul 2\\Sisteme distribuite\\Pregatire_Examen\\problema 2 clean runnable\\problema 2 clean runnable\\StudentMicroservice\\questions_database.txt").readLines()
