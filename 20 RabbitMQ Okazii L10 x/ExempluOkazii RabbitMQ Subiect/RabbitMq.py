...
class RabbitMq():
    ...
    def __init__(self, config):
        ...
        self.loggerProducer = RabbitPC.ProducerLogger(config_logger_producer)
    ...
    def on_received_message(self, blocking_channel,
        ...
        try:
            ...
            self.loggerProducer.send('Wrong data format: ' + str(e))
        finally:
        ...
        with pika.BlockingConnection(self.parameters) as connection:
            ...
            with connection.channel() as channel:
                ...
                # Don't recover connections closed by server
                    ...
                    self.loggerProducer.send('Connection closed by broker. OR  AMQP Channel Error. -> ' + str(e))
                # Don't recover on channel errors
                # Don't recover from KeyboardInterrupt
                except KeyboardInterrupt as e:
                    print("Application closed.")
                    self.loggerProducer.send('Application closed -> ' + str(e))
