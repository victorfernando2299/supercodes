...
class StudentMicroservice {
    ...
    init {
        val databaseLines: List<String> = File("/home/stefan/Documents/Rezolvari Subiecte/27 Teacher-Student Chat Cenzurat L8/problema 2 clean runnable/StudentMicroservice/questions_database.txt").readLines()
