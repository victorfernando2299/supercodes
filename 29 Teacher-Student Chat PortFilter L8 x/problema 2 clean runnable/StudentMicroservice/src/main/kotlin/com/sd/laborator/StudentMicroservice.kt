...
class StudentMicroservice {
    ...
    init {
        val databaseLines: List<String> = File("/home/stefan/Documents/Rezolvari Subiecte/29 Teacher-Student Chat PortFilter L8 x/problema 2 clean runnable/StudentMicroservice/questions_database.txt").readLines()
